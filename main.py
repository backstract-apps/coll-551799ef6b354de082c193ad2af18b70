...
app = FastAPI(title='Backstract Generated APIs - coll-551799ef6b354de082c193ad2af18b70', debug=False,
              docs_url='/lucid-mayer-19afa004eaa211efab560242ac12000565/docs',
              openapi_url='/lucid-mayer-19afa004eaa211efab560242ac12000565/openapi.json')
...
app.include_router(
    router,
    prefix='/lucid-mayer-19afa004eaa211efab560242ac12000565/api',
    tags=['APIs v1']
)
